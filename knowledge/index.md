...
|--------|-------------|--------|---------------|--------|
| [🌍 Языки](#языки) | 4 языка + сравнение + планы | Учебник 15 юнитов + словарь 2000 | ~510 файлов, 161 050 строки | A1 → C2, HSK 1-6, TOPIK, JLPT |
...
| **Всего** | **618 файлов** | — | **269 574 строки** | Все разделы ≥ 1000 |
...
| [🇨🇳 Китайский](languages/chinese/) | 15 | 2995 строк | 5094 строк | 500 → 1000 → 1500 → 2000 | Расширенный учебник; 45 771 строк |
| [🇰🇷 Корейский](languages/korean/) | 15 | 1510 строк | 4309 строк | 500 → 1000 → 1500 → 2000 | Полный курс; 45 125 строки |
...
|--------|------|--------|----------------|-----------|
| 🌍 Языки | `languages/` | 510 | 161 050 | 59,7 % |
...
> Сумма файлов разделов 617 + корневой `index.md` = 618 ✓. Сумма строк 269 574 ✓.
...
| 🇨🇳 Китайский | `languages/chinese/` | 109 | 45 771 |
| 🇰🇷 Корейский | `languages/korean/` | 155 | 45 125 |
...
Основа: `textbook.md` (2 995), `index.md` (1 095), `details.md` (1 006). Итого раздел: **109 файлов, 45 771 строк** — самый объёмный язык.
...
> **Итог по китайскому:** вся база 45 771 строк (**109 файлов**) — самый объёмный язык.

---

### B2.3 🇰🇷 Корейский — `languages/korean/`

Основа: `textbook.md` (1 510), `index.md` (1 430), `details.md` (1 371). Итого раздел: **155 файлов, 45 125 строки**.
...
> **Итог по корейскому:** вся база 45 125 строки (**155 файлов**, +164 строки ресурсные стубы `resources/`); основа 4 311 + юниты (15 × ~1 400) + темы (listening 2 196, exam 2 090, reading 2 013, culture 1 722, cheatsheet 1 713, review 1 569, common-mistakes 1 423, hanja 1 218, writing 1 427, vocabulary 2 858) + словарь 2000.
