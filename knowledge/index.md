...
|--------|-------------|--------|---------------|--------|
| [🌍 Языки](#языки) | 4 языка + сравнение + планы | Учебник 15 юнитов + словарь 2000 | ~510 файлов, 161 044 строки | A1 → C2, HSK 1-6, TOPIK, JLPT |
...
|------|-------|---------|--------|---------|------------|
| [🇯🇵 Японский](languages/japanese/) | 15 | 168 строк | 1412 строк | 500 → 1000 → 1500 → 2000 | Эталонная структура; 44 504 строки |
| [🇨🇳 Китайский](languages/chinese/) | 15 | 2995 строк | 5094 строк | 500 → 1000 → 1500 → 2000 | Расширенный учебник; 45 769 строк |
| [🇰🇷 Корейский](languages/korean/) | 15 | 1510 строк | 4309 строк | 500 → 1000 → 1500 → 2000 | Полный курс; 45 123 строки |
...
|--------|------|--------|----------------|-----------|
| 🌍 Языки | `languages/` | 510 | 161 044 | 59,7 % |
...
| 🇰🇷 Корейский | `languages/korean/` | 155 | 45 123 |
...
Основа: `textbook.md` (1 510), `index.md` (1 428), `details.md` (1 371). Итого раздел: **155 файлов, 45 123 строки**.
...
> **Итог по корейскому:** вся база 45 123 строки (**155 файлов**, +164 строки ресурсные стубы `resources/`); основа 4 309 + юниты (15 × ~1 400) + темы (listening 2 196, exam 2 090, reading 2 013, culture 1 722, cheatsheet 1 713, review 1 569, common-mistakes 1 423, hanja 1 218, writing 1 427, vocabulary 2 858) + словарь 2000.
