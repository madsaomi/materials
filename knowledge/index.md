...
| **Всего** | **619 файлов** | — | **269 616 строк** | Все разделы ≥ 1000 |
...
| [🇰🇷 Корейский](languages/korean/) | 15 | 1510 строк | 4309 строк | 500 → 1000 → 1500 → 2000 | Полный курс; 45 160 строк |
...
> Сумма файлов разделов 618 + корневой `index.md` = 619 ✓. Сумма строк 269 616 ✓.
...
| 🇰🇷 Корейский | `languages/korean/` | 156 | 45 160 |
...
Основа: `textbook.md` (1 510), `index.md` (1 430), `details.md` (1 371). Итого раздел: **156 файлов, 45 160 строк**.
...
> **Итог по корейскому:** вся база 45 160 строк (**156 файлов**, включая раздел `resources/`); основа 4 311 + юниты (15 × ~1 400) + темы (listening 2 196, exam 2 090, reading 2 013, culture 1 722, cheatsheet 1 713, review 1 569, common-mistakes 1 423, hanja 1 218, writing 1 427, vocabulary 2 857, resources 198) + словарь 2000.
...
| languages\korean\vocabulary | 8 | 2857 |
