...
|--------|-------------|--------|---------------|--------|
| [🌍 Языки](#языки) | 4 языка + сравнение + планы | Учебник 15 юнитов + словарь 2000 | ~511 файлов, 161 087 строк | A1 → C2, HSK 1-6, TOPIK, JLPT |
| [🧩 Мнемоника](#мнемоника) | Память (автономный учебник) | 16 файлов, 19 разделов | 29 050 строк | Начальный → Чемпион |
...
| **Всего** | **624 файла** | — | **269 930 строк** | Все разделы ≥ 1000 |
