...
| **Всего** | **619 файлов** | — | **268 787 строк** | Все разделы ≥ 1000 |
...
| [🇨🇳 Китайский](languages/chinese/) | 15 | 2995 строк | 5094 строк | 500 → 1000 → 1500 → 2000 | Расширенный учебник; 45 346 строк |
...
> **Итог по китайскому:** вся база 45 346 строк (**109 файлов**) — самый объёмный язык.
...
| languages\chinese\vocabulary | 7 | 2426 |
