...
|------|------|-----------|
| [Unit 1](unit-01/syntax.md) | Основы синтаксиса | Переменные, типы, условия, циклы, функции, списки |
| [Unit 2](unit-02/syntax.md) | Структуры данных | Словари, множества, генераторы, lambda, файлы, ошибки |
| [Unit 3](unit-03/syntax.md) | ООП и продвинутые темы | Классы, наследование, декораторы, генераторы, stdlib |
